...
public class CIMS_ContactInformation_Permanent_Address {
	...
	//Veriables-------------
	 ...
	 //Constructor----------
	 public CIMS_ContactInformation_Permanent_Address(WebDriver driver,UtilFunction utilfunc) 
		{
	 ...
	 public boolean ContactInformation_Mailing_Address(int ColumnCounter,String mode) throws AWTException, InterruptedException
		 ...
		 String TestcaseID=UtilFunction.getCellData("Test Data.xls", "Contact_Information", 0, ColumnCounter);
			...
			String Contact_InformationScenerio=UtilFunction.getCellData("Test Data.xls", "ContactInfoPermanentAddres", 2, ColumnCounter);
			String Contact_InformationTestcaseDescription=UtilFunction.getCellData("Test Data.xls", "ContactInfoPermanentAddres", 3, ColumnCounter);		
			String Contact_InformationPageURL=UtilFunction.getCellData("Test Data.xls", "ContactInfoPermanentAddres", 4, ColumnCounter);
			String Contact_InformationID=UtilFunction.getCellData("Test Data.xls", "ContactInfoPermanentAddres", 5, ColumnCounter);
			
			String Contact_Information=UtilFunction.getCellData("Test Data.xls", "ContactInfoPermanentAddres", 6, ColumnCounter);
			String Contact_InformationCountry=UtilFunction.getCellData("Test Data.xls", "ContactInfoPermanentAddres", 7, ColumnCounter);
			String Contact_InformationAddressLookup=UtilFunction.getCellData("Test Data.xls", "ContactInfoPermanentAddres", 8, ColumnCounter);
			String Contact_InformationStreetAddress1=UtilFunction.getCellData("Test Data.xls", "ContactInfoPermanentAddres", 9, ColumnCounter);
			String Contact_InformationStreetAddress2=UtilFunction.getCellData("Test Data.xls", "ContactInfoPermanentAddres", 10, ColumnCounter);
			String Contact_InformationAptSteFlr=UtilFunction.getCellData("Test Data.xls", "ContactInfoPermanentAddres", 11, ColumnCounter);
			String Contact_InformationCityTownLocality=UtilFunction.getCellData("Test Data.xls", "ContactInfoPermanentAddres", 12, ColumnCounter);
			String Contact_InformationStateProvinceRegion=UtilFunction.getCellData("Test Data.xls", "ContactInfoPermanentAddres", 13, ColumnCounter);
			String Contact_InformationPostalCode=UtilFunction.getCellData("Test Data.xls", "ContactInfoPermanentAddres", 14, ColumnCounter);
...
//			String Contact_InformationPhoneExt=UtilFunction.getCellData("Test Data.xls", "Contact_Information", 20, ColumnCounter);
			String Contact_InformationSavedaddress=UtilFunction.getCellData("Test Data.xls", "ContactInfoPermanentAddres", 15, ColumnCounter);
			
			String ExpectedErrorMessage=UtilFunction.getCellData("Test Data.xls", "ContactInfoPermanentAddres", 16, ColumnCounter);
...
//			String ResidenceAddressxpath=".//*[@id='divResidence']//*[@class='icon-pencil icon-block']";
			String MailingAddressxpath=".//*[@class='form-horizontal']/div[3]//*[@class='control-group']//*[@class='btn']";
