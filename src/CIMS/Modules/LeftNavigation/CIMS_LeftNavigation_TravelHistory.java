...
public class CIMS_LeftNavigation_TravelHistory {
	...
	public CIMS_LeftNavigation_TravelHistory(WebDriver driver,UtilFunction utilfunc) 
	{
		this.webdriver =driver;
		this.utilfunc=utilfunc;
	}

	public boolean TravelHistory(String filename, String sheetName,int ColumnCounter,String mode) throws AWTException, InterruptedException
	{
