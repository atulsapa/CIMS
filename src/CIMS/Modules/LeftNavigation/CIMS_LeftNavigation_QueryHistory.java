...
public class CIMS_LeftNavigation_QueryHistory {
	...
	public CIMS_LeftNavigation_QueryHistory(WebDriver driver,UtilFunction utilfunc) 
	{
		this.webdriver =driver;
		this.utilfunc=utilfunc;
	}

	public boolean QueryHistory(String filename, String sheetName,int ColumnCounter,String mode) throws AWTException, InterruptedException
	{
