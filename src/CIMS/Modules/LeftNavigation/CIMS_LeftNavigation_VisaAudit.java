...
public class CIMS_LeftNavigation_VisaAudit {
	...
	public CIMS_LeftNavigation_VisaAudit(WebDriver driver,UtilFunction utilfunc) 
	{
		this.webdriver =driver;
		this.utilfunc=utilfunc;
	}

	public boolean VisaAudit(String filename, String sheetName,int ColumnCounter,String mode) throws AWTException, InterruptedException
	{
