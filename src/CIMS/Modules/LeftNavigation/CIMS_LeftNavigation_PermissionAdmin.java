...
public class CIMS_LeftNavigation_PermissionAdmin {
	...
	public CIMS_LeftNavigation_PermissionAdmin(WebDriver driver,UtilFunction utilfunc) 
	{
		this.webdriver =driver;
		this.utilfunc=utilfunc;
	}

	public boolean PermissionAdmin(String filename, String sheetName,int ColumnCounter,String mode) throws AWTException, InterruptedException
	{
