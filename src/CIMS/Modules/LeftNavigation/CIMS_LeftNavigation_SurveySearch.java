...
public class CIMS_LeftNavigation_SurveySearch {
	...
	public CIMS_LeftNavigation_SurveySearch(WebDriver driver,UtilFunction utilfunc) 
	{
		this.webdriver =driver;
		this.utilfunc=utilfunc;
	}

	public boolean SurveySearch(String filename, String sheetName,int ColumnCounter,String mode) throws AWTException, InterruptedException
	{
