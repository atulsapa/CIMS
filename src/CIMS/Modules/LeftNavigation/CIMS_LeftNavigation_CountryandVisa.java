...
public class CIMS_LeftNavigation_CountryandVisa {
	...
	public CIMS_LeftNavigation_CountryandVisa(WebDriver driver,UtilFunction utilfunc) 
	{
		this.webdriver =driver;
		this.utilfunc=utilfunc;
	}

	public boolean CountryandVisa(String filename, String sheetName,int ColumnCounter,String mode) throws AWTException, InterruptedException
	{
