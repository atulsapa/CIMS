...
public class CIMS_LeftNavigation_DocumentTypeAdmin {
	...
	public CIMS_LeftNavigation_DocumentTypeAdmin(WebDriver driver,UtilFunction utilfunc) 
	{
		this.webdriver =driver;
		this.utilfunc=utilfunc;
	}

	public boolean DocumentTypeAdmin(String filename, String sheetName,int ColumnCounter,String mode) throws AWTException, InterruptedException
	{
