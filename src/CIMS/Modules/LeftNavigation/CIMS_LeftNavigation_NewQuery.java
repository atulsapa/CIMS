...
public class CIMS_LeftNavigation_NewQuery {
	...
	public CIMS_LeftNavigation_NewQuery(WebDriver driver,UtilFunction utilfunc) 
	{
		this.webdriver =driver;
		this.utilfunc=utilfunc;
	}

	public boolean NewQuery(String filename, String sheetName,int ColumnCounter,String mode) throws AWTException, InterruptedException
	{
