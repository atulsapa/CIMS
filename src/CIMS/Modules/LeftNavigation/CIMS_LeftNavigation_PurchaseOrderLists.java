...
public class CIMS_LeftNavigation_PurchaseOrderLists {
	...
	public CIMS_LeftNavigation_PurchaseOrderLists(WebDriver driver,UtilFunction utilfunc) 
	{
		this.webdriver =driver;
		this.utilfunc=utilfunc;
	}

	public boolean PurchaseOrderLists(String filename, String sheetName,int ColumnCounter,String mode) throws AWTException, InterruptedException
	{
