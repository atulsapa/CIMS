...
public class CIMS_LeftNavigation_DocumentGeneration {
	...
	public CIMS_LeftNavigation_DocumentGeneration(WebDriver driver,UtilFunction utilfunc) 
	{
		this.webdriver =driver;
		this.utilfunc=utilfunc;
	}

	public boolean DocumentGeneration(String filename, String sheetName,int ColumnCounter,String mode) throws AWTException, InterruptedException
	{
