...
public class CIMS_LeftNavigation_Messages {
	...
	public CIMS_LeftNavigation_Messages(WebDriver driver,UtilFunction utilfunc) 
	{
		this.webdriver =driver;
		this.utilfunc=utilfunc;
	}

	public boolean Messages(String filename, String sheetName,int ColumnCounter,String mode) throws AWTException, InterruptedException
	{
