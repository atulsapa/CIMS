...
public class CIMS_LeftNavigation_MyProfile {
	...
	public CIMS_LeftNavigation_MyProfile(WebDriver driver,UtilFunction utilfunc) 
	{
		this.webdriver =driver;
		this.utilfunc=utilfunc;
	}

	public boolean MyProfile(String filename, String sheetName,int ColumnCounter,String mode) throws AWTException, InterruptedException
	{
