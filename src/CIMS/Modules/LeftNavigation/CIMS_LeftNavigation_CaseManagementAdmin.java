...
public class CIMS_LeftNavigation_CaseManagementAdmin {
	...
	public CIMS_LeftNavigation_CaseManagementAdmin(WebDriver driver,UtilFunction utilfunc) 
	{
		this.webdriver =driver;
		this.utilfunc=utilfunc;
	}

	public boolean CaseManagementAdmin(String filename, String sheetName,int ColumnCounter,String mode) throws AWTException, InterruptedException
	{
