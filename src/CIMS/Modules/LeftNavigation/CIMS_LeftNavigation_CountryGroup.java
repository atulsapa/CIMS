...
public class CIMS_LeftNavigation_CountryGroup {
	...
	public CIMS_LeftNavigation_CountryGroup(WebDriver driver,UtilFunction utilfunc) 
	{
		this.webdriver =driver;
		this.utilfunc=utilfunc;
	}

	public boolean CountryGroup(String filename, String sheetName,int ColumnCounter,String mode) throws AWTException, InterruptedException
	{
