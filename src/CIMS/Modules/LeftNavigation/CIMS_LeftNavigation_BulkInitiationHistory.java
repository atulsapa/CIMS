...
public class CIMS_LeftNavigation_BulkInitiationHistory {
	...
	public CIMS_LeftNavigation_BulkInitiationHistory(WebDriver driver,UtilFunction utilfunc) 
	{
		this.webdriver =driver;
		this.utilfunc=utilfunc;
	}

	public boolean BulkInitiationHistory(String filename, String sheetName,int ColumnCounter,String mode) throws AWTException, InterruptedException
	{
