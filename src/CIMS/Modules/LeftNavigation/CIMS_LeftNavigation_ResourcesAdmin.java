...
public class CIMS_LeftNavigation_ResourcesAdmin {
	...
	public CIMS_LeftNavigation_ResourcesAdmin(WebDriver driver,UtilFunction utilfunc) 
	{
		this.webdriver =driver;
		this.utilfunc=utilfunc;
	}

	public boolean ResourcesAdmin(String filename, String sheetName,int ColumnCounter,String mode) throws AWTException, InterruptedException
	{
