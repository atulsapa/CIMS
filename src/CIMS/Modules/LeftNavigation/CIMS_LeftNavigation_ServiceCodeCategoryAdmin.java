...
public class CIMS_LeftNavigation_ServiceCodeCategoryAdmin {
	...
	public CIMS_LeftNavigation_ServiceCodeCategoryAdmin(WebDriver driver,UtilFunction utilfunc) 
	{
		this.webdriver =driver;
		this.utilfunc=utilfunc;
	}

	public boolean ServiceCodeCategoryAdmin(String filename, String sheetName,int ColumnCounter,String mode) throws AWTException, InterruptedException
	{
