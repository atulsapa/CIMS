...
public class CIMS_LeftNavigation_ServiceCodeClassificationAdmin {
	...
	public CIMS_LeftNavigation_ServiceCodeClassificationAdmin(WebDriver driver,UtilFunction utilfunc) 
	{
		this.webdriver =driver;
		this.utilfunc=utilfunc;
	}

	public boolean ServiceCodeClassificationAdmin(String filename, String sheetName,int ColumnCounter,String mode) throws AWTException, InterruptedException
	{
