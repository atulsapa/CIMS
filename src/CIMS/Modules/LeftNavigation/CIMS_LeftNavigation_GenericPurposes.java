...
public class CIMS_LeftNavigation_GenericPurposes {
	...
	public CIMS_LeftNavigation_GenericPurposes(WebDriver driver,UtilFunction utilfunc) 
	{
		this.webdriver =driver;
		this.utilfunc=utilfunc;
	}

	public boolean GenericPurposes(String filename, String sheetName,int ColumnCounter,String mode) throws AWTException, InterruptedException
	{
