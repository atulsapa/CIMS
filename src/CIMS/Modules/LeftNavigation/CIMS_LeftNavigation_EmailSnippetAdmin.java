...
public class CIMS_LeftNavigation_EmailSnippetAdmin {
	...
	public CIMS_LeftNavigation_EmailSnippetAdmin(WebDriver driver,UtilFunction utilfunc) 
	{
		this.webdriver =driver;
		this.utilfunc=utilfunc;
	}

	public boolean EmailSnippetAdmin(String filename, String sheetName,int ColumnCounter,String mode) throws AWTException, InterruptedException
	{
