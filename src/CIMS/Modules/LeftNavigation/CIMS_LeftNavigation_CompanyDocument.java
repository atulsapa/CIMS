...
public class CIMS_LeftNavigation_CompanyDocument {
	...
	public CIMS_LeftNavigation_CompanyDocument(WebDriver driver,UtilFunction utilfunc) 
	{
		this.webdriver =driver;
		this.utilfunc=utilfunc;
	}

	public boolean CompanyDocument(String filename, String sheetName,int ColumnCounter,String mode) throws AWTException, InterruptedException
	{
