...
public class CIMS_LeftNavigation_PolicyDisclaimer {
	...
	public CIMS_LeftNavigation_PolicyDisclaimer(WebDriver driver,UtilFunction utilfunc) 
	{
		this.webdriver =driver;
		this.utilfunc=utilfunc;
	}

	public boolean PolicyDisclaimer(String filename, String sheetName,int ColumnCounter,String mode) throws AWTException, InterruptedException
	{
