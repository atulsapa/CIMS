...
public class CIMS_LeftNavigation_EmployeeSearch {
	...
	public CIMS_LeftNavigation_EmployeeSearch(WebDriver driver,UtilFunction utilfunc) 
	{
		this.webdriver =driver;
		this.utilfunc=utilfunc;
	}

	public boolean EmployeeSearch(String filename, String sheetName,int ColumnCounter,String mode) throws AWTException, InterruptedException
	{
