...
public class CIMS_LeftNavigation_ImmigrationStatus {
	...
	public CIMS_LeftNavigation_ImmigrationStatus(WebDriver driver,UtilFunction utilfunc) 
	{
		this.webdriver =driver;
		this.utilfunc=utilfunc;
	}

	public boolean ImmigrationStatus(String filename, String sheetName,int ColumnCounter,String mode) throws AWTException, InterruptedException
	{
