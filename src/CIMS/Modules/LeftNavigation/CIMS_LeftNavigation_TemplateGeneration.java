...
public class CIMS_LeftNavigation_TemplateGeneration {
	...
	public CIMS_LeftNavigation_TemplateGeneration(WebDriver driver,UtilFunction utilfunc) 
	{
		this.webdriver =driver;
		this.utilfunc=utilfunc;
	}

	public boolean TemplateGeneration(String filename, String sheetName,int ColumnCounter,String mode) throws AWTException, InterruptedException
	{
