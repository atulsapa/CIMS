...
public class CIMS_Visa_Audit {
	...
	public static String testcaseid="";
	 ...
	 public CIMS_Visa_Audit(WebDriver driver,UtilFunction utilfunc) {
	    	  {
		...
		public boolean Visa_Audit(String filename, String sheetName,int ColumnCounter,String mode) throws AWTException, InterruptedException{
			...
			if(TestcaseRunMode.equals("Y")){
				...
				if(mode.equals("New")|| mode.equals("Edit")){
					...
					String SearchDateOfArrival=".//*[@id='CreatedDateFrom']";
					String SearchDateOfDeparture=".//*[@id='CreatedDateTo']";
							   ...
							   String FirstRecordXpath =".//*[@id='serachpanel']//tbody//tr[1]//td[2]//a";
								...
								for(int i=1; i<=resultCount; i++){
									...
									try {
										...
										if(AttributeName.equals("ResultVerified_7721")){
										...
										}else if(AttributeName.equals("txtNote_7721")){
