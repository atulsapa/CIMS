											...
											try{
												...
												if(ModuleName.equals("Initiate a Project")){
													...
													try{
														...
														try{Page_flag	=	obj_CIMS_LeftNavigation_InitiateAProject.InitiateAProject(fileName,sheetName,count,ActionName);
														}catch(Exception e){}
												...
												//Project Search
													...
													try{
														timer="0";
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														try{Page_flag	=	obj_CIMS_LeftNavigation_ProjectSearch.ProjectSearch(fileName,sheetName,count,ActionName);
														}catch(Exception e){}
														timer = utilfunc.getTimeTakenByModule(startTime);
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														if (Page_flag)
												...
												//Employee Search
													...
													try{
														timer="0";
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														try{Page_flag	=	obj_CIMS_LeftNavigation_EmployeeSearch.EmployeeSearch(fileName,sheetName,count,ActionName);
														}catch(Exception e){}
														timer = utilfunc.getTimeTakenByModule(startTime);
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														if (Page_flag)
												...
												//My Profile
													...
													try{
														timer="0";
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														try{Page_flag	=	obj_CIMS_LeftNavigation_MyProfile.MyProfile(fileName,sheetName,count,ActionName);
														}catch(Exception e){}
														timer = utilfunc.getTimeTakenByModule(startTime);
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														if (Page_flag)
												...
												//Immigration Status
													...
													try{
														timer="0";
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														try{Page_flag	=	obj_CIMS_LeftNavigation_ImmigrationStatus.ImmigrationStatus(fileName,sheetName,count,ActionName);
														}catch(Exception e){}
														timer = utilfunc.getTimeTakenByModule(startTime);
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														if (Page_flag)
												...
												//Priority Dates
													...
													try{
														timer="0";
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														try{Page_flag	=	obj_CIMS_LeftNavigation_PriorityDates.PriorityDates(fileName,sheetName,count,ActionName);
														}catch(Exception e){}
														timer = utilfunc.getTimeTakenByModule(startTime);
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														if (Page_flag)
												...
												//Messages
													...
													try{
														timer="0";
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														try{Page_flag	=	obj_CIMS_LeftNavigation_Messages.Messages(fileName,sheetName,count,ActionName);
														}catch(Exception e){}
														timer = utilfunc.getTimeTakenByModule(startTime);
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														if (Page_flag)
												...
												//News
													...
													try{
														timer="0";
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														try{Page_flag	=	obj_CIMS_LeftNavigation_News.News(fileName,sheetName,count,ActionName);
														}catch(Exception e){}
														timer = utilfunc.getTimeTakenByModule(startTime);
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														if (Page_flag)
												...
												//Company
													...
													try{
														timer="0";
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														try{Page_flag	=	obj_CIMS_LeftNavigation_Company.Company(fileName,sheetName,count,ActionName);
														}catch(Exception e){}
														timer = utilfunc.getTimeTakenByModule(startTime);
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														if (Page_flag)
												...
												//New Query
													...
													try{
														timer="0";
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														try{Page_flag	=	obj_CIMS_LeftNavigation_NewQuery.NewQuery(fileName,sheetName,count,ActionName);
														}catch(Exception e){}
														timer = utilfunc.getTimeTakenByModule(startTime);
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														if (Page_flag)
												...
												//Query History
													...
													try{
														timer="0";
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														try{Page_flag	=	obj_CIMS_LeftNavigation_QueryHistory.QueryHistory(fileName,sheetName,count,ActionName);
														}catch(Exception e){}
														timer = utilfunc.getTimeTakenByModule(startTime);
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														if (Page_flag)
												...
												//Visa Audit
													...
													try{
														timer="0";
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														try{Page_flag	=	obj_CIMS_LeftNavigation_VisaAudit.VisaAudit(fileName,sheetName,count,ActionName);
														}catch(Exception e){}
														timer = utilfunc.getTimeTakenByModule(startTime);
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														if (Page_flag)
												...
												//Travel History
													...
													try{
														timer="0";
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														try{Page_flag	=	obj_CIMS_LeftNavigation_TravelHistory.TravelHistory(fileName,sheetName,count,ActionName);
														}catch(Exception e){}
														timer = utilfunc.getTimeTakenByModule(startTime);
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														if (Page_flag)
												...
												//Document Generation
													...
													try{
														timer="0";
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														try{Page_flag	=	obj_CIMS_LeftNavigation_DocumentGeneration.DocumentGeneration(fileName,sheetName,count,ActionName);
														}catch(Exception e){}
														timer = utilfunc.getTimeTakenByModule(startTime);
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														if (Page_flag)
												...
												//Template Generation
													...
													try{
														timer="0";
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														try{Page_flag	=	obj_CIMS_LeftNavigation_TemplateGeneration.TemplateGeneration(fileName,sheetName,count,ActionName);
														}catch(Exception e){}
														timer = utilfunc.getTimeTakenByModule(startTime);
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														if (Page_flag)
												...
												//Purchase Order Lists
													...
													try{
														timer="0";
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														try{Page_flag	=	obj_CIMS_LeftNavigation_PurchaseOrderLists.PurchaseOrderLists(fileName,sheetName,count,ActionName);
														}catch(Exception e){}
														timer = utilfunc.getTimeTakenByModule(startTime);
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														if (Page_flag)
												...
												//Bulk Initiation History
													...
													try{
														timer="0";
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														try{Page_flag	=	obj_CIMS_LeftNavigation_BulkInitiationHistory.BulkInitiationHistory(fileName,sheetName,count,ActionName);
														}catch(Exception e){}
														timer = utilfunc.getTimeTakenByModule(startTime);
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														if (Page_flag)
												...
												//Case Management Admin
													...
													try{
														timer="0";
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														try{Page_flag	=	obj_CIMS_LeftNavigation_CaseManagementAdmin.CaseManagementAdmin(fileName,sheetName,count,ActionName);
														}catch(Exception e){}
														timer = utilfunc.getTimeTakenByModule(startTime);
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														if (Page_flag)
												...
												//Document Type Admin    
													...
													try{
														timer="0";
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														try{Page_flag	=	obj_CIMS_LeftNavigation_DocumentTypeAdmin.DocumentTypeAdmin(fileName,sheetName,count,ActionName);
														}catch(Exception e){}
														timer = utilfunc.getTimeTakenByModule(startTime);
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														if (Page_flag)
												...
												//Email Snippet Admin  
													...
													try{
														timer="0";
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														try{Page_flag	=	obj_CIMS_LeftNavigation_EmailSnippetAdmin.EmailSnippetAdmin(fileName,sheetName,count,ActionName);
														}catch(Exception e){}
														timer = utilfunc.getTimeTakenByModule(startTime);
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														if (Page_flag)
												...
												//Global Reference List   
													...
													try{
														timer="0";
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														try{Page_flag	=	obj_CIMS_LeftNavigation_GlobalReferenceList.GlobalReferenceList(fileName,sheetName,count,ActionName);
														}catch(Exception e){}
														timer = utilfunc.getTimeTakenByModule(startTime);
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														if (Page_flag)
												...
												//Government Priority Dates 
													...
													try{
														timer="0";
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														try{Page_flag	=	obj_CIMS_LeftNavigation_GovernmentPriorityDates.GovernmentPriorityDates(fileName,sheetName,count,ActionName);
														}catch(Exception e){}
														timer = utilfunc.getTimeTakenByModule(startTime);
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														if (Page_flag)
												...
												//News Admin
													...
													try{
														timer="0";
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														try{Page_flag	=	obj_CIMS_LeftNavigation_NewsAdmin.NewsAdmin(fileName,sheetName,count,ActionName);
														}catch(Exception e){}
														timer = utilfunc.getTimeTakenByModule(startTime);
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														if (Page_flag)
												...
												//Notification Admin 
													...
													try{
														timer="0";
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														try{Page_flag	=	obj_CIMS_LeftNavigation_NotificationAdmin.NotificationAdmin(fileName,sheetName,count,ActionName);
														}catch(Exception e){}
														timer = utilfunc.getTimeTakenByModule(startTime);
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														if (Page_flag)
												...
												//Policy Disclaimer 
													...
													try{
														timer="0";
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														try{Page_flag	=	obj_CIMS_LeftNavigation_PolicyDisclaimer.PolicyDisclaimer(fileName,sheetName,count,ActionName);
														}catch(Exception e){}
														timer = utilfunc.getTimeTakenByModule(startTime);
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														if (Page_flag)
												...
												//Questionnaire Admin 
													...
													try{
														timer="0";
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														try{Page_flag	=	obj_CIMS_LeftNavigation_QuestionnaireAdmin.QuestionnaireAdmin(fileName,sheetName,count,ActionName);
														}catch(Exception e){}
														timer = utilfunc.getTimeTakenByModule(startTime);
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														if (Page_flag)
												...
												//Report Admin 
													...
													try{
														timer="0";
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														try{Page_flag	=	obj_CIMS_LeftNavigation_ReportAdmin.ReportAdmin(fileName,sheetName,count,ActionName);
														}catch(Exception e){}
														timer = utilfunc.getTimeTakenByModule(startTime);
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														if (Page_flag)
												...
												//Resources Admin
													...
													try{
														timer="0";
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														try{Page_flag	=	obj_CIMS_LeftNavigation_ResourcesAdmin.ResourcesAdmin(fileName,sheetName,count,ActionName);
														}catch(Exception e){}
														timer = utilfunc.getTimeTakenByModule(startTime);
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														if (Page_flag)
												...
												//Permission Admin PermissionAdmin
													...
													try{
														timer="0";
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														try{Page_flag	=	obj_CIMS_LeftNavigation_PermissionAdmin.PermissionAdmin(fileName,sheetName,count,ActionName);
														}catch(Exception e){}
														timer = utilfunc.getTimeTakenByModule(startTime);
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														if (Page_flag)
												...
												//Role Admin 
													...
													try{
														timer="0";
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														try{Page_flag	=	obj_CIMS_LeftNavigation_RoleAdmin.RoleAdmin(fileName,sheetName,count,ActionName);
														}catch(Exception e){}
														timer = utilfunc.getTimeTakenByModule(startTime);
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														if (Page_flag)
												...
												//Service Code Category Admin   
													...
													try{
														timer="0";
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														try{Page_flag	=	obj_CIMS_LeftNavigation_ServiceCodeCategoryAdmin.ServiceCodeCategoryAdmin(fileName,sheetName,count,ActionName);
														}catch(Exception e){}
														timer = utilfunc.getTimeTakenByModule(startTime);
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														if (Page_flag)
												...
												//Service Code Classification Admin    
													...
													try{
														timer="0";
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														try{Page_flag	=	obj_CIMS_LeftNavigation_ServiceCodeClassificationAdmin.ServiceCodeClassificationAdmin(fileName,sheetName,count,ActionName);
														}catch(Exception e){}
														timer = utilfunc.getTimeTakenByModule(startTime);
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														if (Page_flag)
												...
												//Survey Search
													...
													try{
														timer="0";
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														try{Page_flag	=	obj_CIMS_LeftNavigation_SurveySearch.SurveySearch(fileName,sheetName,count,ActionName);
														}catch(Exception e){}
														timer = utilfunc.getTimeTakenByModule(startTime);
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														if (Page_flag)
												...
												//Country & Visa   
													...
													try{
														timer="0";
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														try{Page_flag	=	obj_CIMS_LeftNavigation_CountryandVisa.CountryandVisa(fileName,sheetName,count,ActionName);
														}catch(Exception e){}
														timer = utilfunc.getTimeTakenByModule(startTime);
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														if (Page_flag)
												...
												//Country Group  
													...
													try{
														timer="0";
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														try{Page_flag	=	obj_CIMS_LeftNavigation_CountryGroup.CountryGroup(fileName,sheetName,count,ActionName);
														}catch(Exception e){}
														timer = utilfunc.getTimeTakenByModule(startTime);
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														if (Page_flag)
												...
												//Generic Purpose  
													...
													try{
														timer="0";
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														try{Page_flag	=	obj_CIMS_LeftNavigation_GenericPurposes.GenericPurposes(fileName,sheetName,count,ActionName);
														}catch(Exception e){}
														timer = utilfunc.getTimeTakenByModule(startTime);
														utilfunc.updateModuleDataForReportGeneration(ModuleName, Employee_namecheck, timer);
														if (Page_flag)
