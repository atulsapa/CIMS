...
import CIMS.Modules.LeftNavigation.CIMS_LeftNavigation_BulkInitiationHistory;
import CIMS.Modules.LeftNavigation.CIMS_LeftNavigation_CaseManagementAdmin;
import CIMS.Modules.LeftNavigation.CIMS_LeftNavigation_Company;
import CIMS.Modules.LeftNavigation.CIMS_LeftNavigation_CompanyDocument;
import CIMS.Modules.LeftNavigation.CIMS_LeftNavigation_CountryGroup;
import CIMS.Modules.LeftNavigation.CIMS_LeftNavigation_CountryandVisa;
import CIMS.Modules.LeftNavigation.CIMS_LeftNavigation_DocumentGeneration;
import CIMS.Modules.LeftNavigation.CIMS_LeftNavigation_DocumentTypeAdmin;
import CIMS.Modules.LeftNavigation.CIMS_LeftNavigation_EmailSnippetAdmin;
import CIMS.Modules.LeftNavigation.CIMS_LeftNavigation_EmployeeSearch;
import CIMS.Modules.LeftNavigation.CIMS_LeftNavigation_GenericPurposes;
import CIMS.Modules.LeftNavigation.CIMS_LeftNavigation_GlobalReferenceList;
import CIMS.Modules.LeftNavigation.CIMS_LeftNavigation_GovernmentPriorityDates;
import CIMS.Modules.LeftNavigation.CIMS_LeftNavigation_ImmigrationStatus;
import CIMS.Modules.LeftNavigation.CIMS_LeftNavigation_InitiateAProject;
import CIMS.Modules.LeftNavigation.CIMS_LeftNavigation_Messages;
import CIMS.Modules.LeftNavigation.CIMS_LeftNavigation_MyProfile;
import CIMS.Modules.LeftNavigation.CIMS_LeftNavigation_NewQuery;
import CIMS.Modules.LeftNavigation.CIMS_LeftNavigation_News;
import CIMS.Modules.LeftNavigation.CIMS_LeftNavigation_NewsAdmin;
import CIMS.Modules.LeftNavigation.CIMS_LeftNavigation_NotificationAdmin;
import CIMS.Modules.LeftNavigation.CIMS_LeftNavigation_PermissionAdmin;
import CIMS.Modules.LeftNavigation.CIMS_LeftNavigation_PolicyDisclaimer;
import CIMS.Modules.LeftNavigation.CIMS_LeftNavigation_PriorityDates;
import CIMS.Modules.LeftNavigation.CIMS_LeftNavigation_ProjectSearch;
import CIMS.Modules.LeftNavigation.CIMS_LeftNavigation_PurchaseOrderLists;
import CIMS.Modules.LeftNavigation.CIMS_LeftNavigation_QueryHistory;
import CIMS.Modules.LeftNavigation.CIMS_LeftNavigation_QuestionnaireAdmin;
import CIMS.Modules.LeftNavigation.CIMS_LeftNavigation_ReportAdmin;
import CIMS.Modules.LeftNavigation.CIMS_LeftNavigation_ResourcesAdmin;
import CIMS.Modules.LeftNavigation.CIMS_LeftNavigation_RoleAdmin;
import CIMS.Modules.LeftNavigation.CIMS_LeftNavigation_ServiceCodeCategoryAdmin;
import CIMS.Modules.LeftNavigation.CIMS_LeftNavigation_ServiceCodeClassificationAdmin;
import CIMS.Modules.LeftNavigation.CIMS_LeftNavigation_SurveySearch;
import CIMS.Modules.LeftNavigation.CIMS_LeftNavigation_TemplateGeneration;
import CIMS.Modules.LeftNavigation.CIMS_LeftNavigation_TravelHistory;
import CIMS.Modules.LeftNavigation.CIMS_LeftNavigation_VisaAudit;
...
import CIMS.Reports.*;
import CIMS.Modules.MyTasksProjectHistory.*;




@SuppressWarnings("deprecation")
public class CIMS_MyTaskProjectHistory {
	...
	private CIMS_MyTasksProjectHistory_AllMyTasks			obj_CIMS_MyTasksProjectHistory_AllMyTasks; 
	...
	public static String ExcelFileName="Test MyTasksProjectHistory Data.xls";
	public static String suiteName		=	"MyTasksProjectHistory";
	...
	public void isSkipped(){
		...
		if(RunMode.isSkip(ExcelFileName,this.getClass().getName())){
			...
			setobj_CIMS_MyTasksProjectHistory_AllMyTasks(new CIMS_MyTasksProjectHistory_AllMyTasks(webdriver,utilfunc));
	...
	public void CIMSSingleProjectInitiation() throws InterruptedException, IOException, AWTException {
		...
		System.out.println("Operating system is"+p);*/
			...
			String []	EmpDependantSuiteName		=	{"Immigration Status","Employee Profile","Document","ProcessQuestionnaire Assignment","Most Recent","Project Detail","Assessment Summary","Secure Messaging"};
			...
			//for AllMyTask
			int AllMyTask_PositiveScenarioCounter	=	0;
			int AllMyTask_NegativeScenarioCounter	=	0;
			int AllMyTask_TotalTestCaseCounter		=	0;
			int AllMyTask_passTestCaseCounter		=	0;
			int AllMyTask_failTestCaseCounter		=	0;
			int AllMyTask_NotAssignedModuleCounter	=	0;
			int AllMyTask_ModuleCounter				=	1;
			...
			String 	RegressionSuites				=		"MyTasksProjectHistory";
			...
			for(int modCounter = 1;modCounter<RowCount;modCounter++){
				...
				try{
					...
					//Flags used for News Module
					boolean AllMyTasks_NotassignFlag=false;
					boolean AllMyTasks_PassFlag=false;
					boolean AllMyTasks_FailFlag=false;
					boolean AllMyTasks_NegativePassFlag=false;
...
//								ArrayList NumberOfNotAssignModule = new ArrayList();
						...
						for(int count=1; count<rowCount; count++)
						{
		    				...
		    				{
		    					System.out.println("\n---\n---\n---\tAll my tasks");
		    					String AllMyTask_Scenariotext	= 	UtilFunction.getCellData(fileName, sheetName, Scenariocol, count);
								if(AllMyTask_Scenariotext.equals("Positive") || AllMyTask_Scenariotext.contains("sitive") || AllMyTask_Scenariotext.contains("Pos")){
									AllMyTask_PositiveScenarioCounter++;
								}else if(AllMyTask_Scenariotext.equals("Negative") || AllMyTask_Scenariotext.contains("gative") || AllMyTask_Scenariotext.contains("gavtive") ){
									AllMyTask_NegativeScenarioCounter++;
								}
								AllMyTask_TotalTestCaseCounter++;
		    					
								
								System.out.println("We are on AllMyTasks.........");
								try{
...
//									System.out.println("we have to go to home page...");
								...
								int AllMyTaskSectionisAssignedorNot_gettext=-0;
								String AllMyTaskSectionisAssignedorNot_Xpath=".//*[@id='worklist_wrapper']"; 
								try{
									AllMyTaskSectionisAssignedorNot_gettext=utilfunc.GetObjectCount(AllMyTaskSectionisAssignedorNot_Xpath);
								}catch(Exception error){}

								startTime = System.currentTimeMillis();

								//check News is assigned to the user or not.
								if(AllMyTaskSectionisAssignedorNot_gettext==1)
								{//News is assigned to the user
									try{
										try{
											Page_flag	=	obj_CIMS_MyTasksProjectHistory_AllMyTasks.AllMyTasks(fileName,SuiteName,count,ActionName);
										}catch(Exception error){}
										...
										{
											status="PASS";
											AllMyTask_passTestCaseCounter++;
											if(utilfunc.globalerrormessage.equals(""))
											{
												utilfunc.TestngReportPass(obj_CIMS_MyTasksProjectHistory_AllMyTasks.testcaseid, utilfunc.Actualbrw, obj_CIMS_MyTasksProjectHistory_AllMyTasks.scenerio, ActionName, obj_CIMS_MyTasksProjectHistory_AllMyTasks.description, status);
												// now write it in a pass file START...
												if(AllMyTasks_PassFlag==false){
													try {	obj_Report_Dashboard.writeReportHeader(SuiteName, SuiteName, "Pass");
													}catch(Exception e){}
													AllMyTasks_PassFlag=true;
												}// now write it in a pass file ENDS...

												//Write Positive Pass dashboard report 
												try {
													obj_Report_Dashboard.writeDashBoardPassReport(SuiteName, Employee_namecheck, obj_CIMS_MyTasksProjectHistory_AllMyTasks.testcaseid, utilfunc.Actualbrw, obj_CIMS_MyTasksProjectHistory_AllMyTasks.scenerio, ActionName, obj_CIMS_MyTasksProjectHistory_AllMyTasks.description, status, timer);
												}catch(Exception e){
													System.out.println("unable to write dasboard pass report for : "+SuiteName);}
											...
											{
												utilfunc.TestngReportNegativePassTestcase(obj_CIMS_MyTasksProjectHistory_AllMyTasks.testcaseid, utilfunc.Actualbrw,obj_CIMS_MyTasksProjectHistory_AllMyTasks.scenerio,ActionName,obj_CIMS_MyTasksProjectHistory_AllMyTasks.description, status, utilfunc.ErrorMessage2,utilfunc.ErrorMessage1,utilfunc.ErrorMessage4);
												// now write it in a negative pass dashboard file START...
												if(AllMyTasks_NegativePassFlag==false){
													try {	obj_Report_Dashboard.writeReportHeader(SuiteName, SuiteName,"Negative Pass");
													}catch(Exception e){}
													AllMyTasks_NegativePassFlag=true;
												}// now write it in a negative pass dashboard file ENDS...

												//Write negative pass dashboard report   obj_Project_Initiation.testcaseId
												try {
													obj_Report_Dashboard.writeDashBoardNegativePassReport(SuiteName,Employee_namecheck,obj_CIMS_MyTasksProjectHistory_AllMyTasks.testcaseid,utilfunc.Actualbrw,obj_CIMS_MyTasksProjectHistory_AllMyTasks.scenerio,ActionName,obj_CIMS_MyTasksProjectHistory_AllMyTasks.description,status,timer,utilfunc.ErrorMessage2,utilfunc.ErrorMessage1,utilfunc.ErrorMessage4);
												} catch (Exception e) {
													System.out.println("unable to write dasboard negative pass report for : "+ SuiteName);}
											}
											/*if(passCounter==false){
										...
										{
											status="FAIL";
											AllMyTask_failTestCaseCounter++;
											//									utilfunc.TakeScreenshot();
											utilfunc.TestngReportFail1(obj_CIMS_MyTasksProjectHistory_AllMyTasks.testcaseid, utilfunc.Actualbrw, obj_CIMS_MyTasksProjectHistory_AllMyTasks.scenerio,ActionName, obj_CIMS_MyTasksProjectHistory_AllMyTasks.description, status, utilfunc.ErrorMessage2,utilfunc.ErrorMessage1,utilfunc.ErrorMessage4);
											// now write it in a fail dashboard file START...
											...
											try {
												obj_Report_Dashboard.writeDashBoardFailReport(SuiteName, Employee_namecheck, obj_CIMS_MyTasksProjectHistory_AllMyTasks.testcaseid, utilfunc.Actualbrw, obj_CIMS_MyTasksProjectHistory_AllMyTasks.scenerio,ActionName, obj_CIMS_MyTasksProjectHistory_AllMyTasks.description, status, timer, utilfunc.ErrorMessage2,utilfunc.ErrorMessage1,utilfunc.ErrorMessage4);
											} catch (Exception e) {
												System.out.println("unable to write dasboard fail report for : "+SuiteName);}
											...
											try {obj_Report_Dashboard.writeDashBoardFailReport(RegressionSuites, Employee_namecheck, obj_CIMS_MyTasksProjectHistory_AllMyTasks.testcaseid, utilfunc.Actualbrw, obj_CIMS_MyTasksProjectHistory_AllMyTasks.scenerio,ActionName, obj_CIMS_MyTasksProjectHistory_AllMyTasks.description, status, timer, utilfunc.ErrorMessage2,utilfunc.ErrorMessage1,utilfunc.ErrorMessage4);} catch (Exception e) {System.out.println("unable to write dasboard fail report for : "+SuiteName);}
											 */
										}
									}catch(Exception e){
										ErrorUtil.addVerificationFailure(new Throwable("Error Occured !!"));
								...
								{//News is not assigned to the user
									...
									timer = utilfunc.getTimeTakenByModule(startTime);
									status="PASS";
									String AllMyTasks_Errormessage="";
									String AllMyTasks_NotAssignTestCaseID="";
									String AllMyTasks_NotAssignScenerio="";
									String AllMyTasks_NotAssignTestCaseDescription="";
									int AllMyTasks_columnNumber_TCID;
									int AllMyTasks_columnNumber_Scenario;
									int AllMyTasks_columnNumber_TestCaseDescription;

									utilfunc.updateModuleDataForReportGeneration(SuiteName, Employee_namecheck, timer);
									AllMyTasks_Errormessage=""+SuiteName+" is not assigned to "+Employee_namecheck+" User";
									System.out.println(AllMyTasks_Errormessage);

									AllMyTasks_columnNumber_TCID						=		UtilFunction.getColumnWithCellData(fileName, sheetName, "TCID");
									AllMyTasks_columnNumber_Scenario					=		UtilFunction.getColumnWithCellData(fileName, sheetName, "SCENARIO");
									AllMyTasks_columnNumber_TestCaseDescription		=		UtilFunction.getColumnWithCellData(fileName, sheetName, "Test Case Description");

									AllMyTasks_NotAssignTestCaseID=UtilFunction.getCellData(fileName, sheetName, AllMyTasks_columnNumber_TCID, count);
									AllMyTasks_NotAssignScenerio=UtilFunction.getCellData(fileName, sheetName, AllMyTasks_columnNumber_Scenario, count);
									AllMyTasks_NotAssignTestCaseDescription=UtilFunction.getCellData(fileName, sheetName, AllMyTasks_columnNumber_TestCaseDescription, count);

									utilfunc.TestngReportFail(AllMyTasks_NotAssignTestCaseID, utilfunc.Actualbrw, AllMyTasks_NotAssignScenerio,ActionName,AllMyTasks_NotAssignTestCaseDescription,status,AllMyTasks_Errormessage);
									//now write it in a notAssign file START...
									if(AllMyTasks_NotassignFlag==false){
										try{	obj_Report_Dashboard.writeReportHeader(SuiteName, SuiteName,"Not Assigned");
										}catch(Exception e){}
										AllMyTasks_NotassignFlag=true;
									}//now write it in a notAssign file ENDS...
									AllMyTask_NotAssignedModuleCounter=1;	
									try {
										obj_Report_Dashboard.writeDashBoardNotAssignedReport(SuiteName, Employee_namecheck, AllMyTasks_NotAssignTestCaseID, utilfunc.Actualbrw, AllMyTasks_NotAssignScenerio, ActionName, AllMyTasks_NotAssignTestCaseDescription, "Not Assigned", utilfunc.timer);
									} catch (InterruptedException e) {
										System.out.println("unable to write Not Assign report");
									}
								}
...
//			TotalTime = utilfunc.getTimeTakenByModule(startTotalTime);
	...
	/////////////// code for AllMyTasks...////////////////////			
				// get total time to execuite the AllMyTasks module
				String AllMytaskFileTime			= "00";
				try{
					AllMytaskFileTime		=	obj_Report_Dashboard.ReadFromFile(dashboard.projectReportTempPath + "regression_time"+File.separator+"all_my_tasks_time");
					System.out.println("\n\n\t\tNEwsFileTime :"+AllMytaskFileTime+"\n\n");
//					AllMytaskFileTime		=	obj_Report_Dashboard.convertSecondsInHourMinuteSeconds(AllMytaskFileTime);
//					System.out.println("\n\n\t\tNewsFileTime:"+AllMytaskFileTime);
				}catch(Exception e){
					System.out.println("unable to write for module: "+moduleName);
				}
				
				System.out.println("\n\n\n------\nAllMyTask_TotalTestCaseCounter"+AllMyTask_TotalTestCaseCounter);
				System.out.println("AllMyTask_PositiveScenarioCounter"+AllMyTask_PositiveScenarioCounter);
				System.out.println("AllMyTask_NegativeScenarioCounter"+AllMyTask_NegativeScenarioCounter);
				System.out.println("AllMyTask_passTestCaseCounter"+AllMyTask_passTestCaseCounter);
				System.out.println("AllMyTask_failTestCaseCounter"+AllMyTask_failTestCaseCounter);
				System.out.println("AllMyTask_NotAssignedModuleCounter"+AllMyTask_NotAssignedModuleCounter);
				System.out.println("AllMytaskFileTime"+AllMytaskFileTime);
				
				try{
					obj_Report_Dashboard.generateReportForSuite(suiteName,
							"1",
							Integer.toString(AllMyTask_TotalTestCaseCounter),
							Integer.toString(AllMyTask_PositiveScenarioCounter),
							Integer.toString(AllMyTask_NegativeScenarioCounter),
							Integer.toString(AllMyTask_passTestCaseCounter),
							Integer.toString(AllMyTask_failTestCaseCounter),
							AllMytaskFileTime,
							Integer.toString(AllMyTask_NotAssignedModuleCounter));
				}catch(Exception e){
					System.out.println("unable to call & generate dashboard report for \"Regression - News\"");
				}
	...
	//Lokesh Append this code for "All My Tasks" on Welcome Page
	public void setobj_CIMS_MyTasksProjectHistory_AllMyTasks(CIMS_MyTasksProjectHistory_AllMyTasks setobj_CIMS_MyTasksProjectHistory_AllMyTasks){
				this.obj_CIMS_MyTasksProjectHistory_AllMyTasks	=	setobj_CIMS_MyTasksProjectHistory_AllMyTasks;
			}
	//Lokesh Append this code for "News" on Welcome Page
