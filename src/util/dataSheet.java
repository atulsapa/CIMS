...
public class dataSheet {
    ...
    {
    try{
    wbook = Workbook.getWorkbook(new File(System.getProperty("user.dir")+"/test-output/testSampleData.xls"));
    wwbCopy = Workbook.createWorkbook(new File(System.getProperty("user.dir")+"/test-output/testSampleDataCopy.xls"), wbook);
